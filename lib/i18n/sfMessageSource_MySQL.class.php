...
class sfMessageSource_MySQL extends sfMessageSource
{
  ...
  protected function getCatalogueDetails($catalogue = 'messages')
  {
    ...
    $rs = mysqli_query($this->db, "SELECT COUNT(*) FROM trans_unit WHERE cat_id = {$cat_id}");
  ...
  function delete($message, $catalogue = 'messages')
  {
    ...
    $statement = "DELETE FROM trans_unit WHERE cat_id = {$cat_id} AND source = '{$text}'";
    $deleted = false;
